...
Public Class INIFile
    ...
    Public Sub Load(ByVal FileName As String, Optional ByVal Merge As Boolean = False)
        If Not Merge Then
            RemoveAllSections()
        End If
        '  Clear the object... 
        ...
        While Not oReader.EndOfStream
            ...
            If line <> String.Empty Then
                ...
                Else
                    '  This should not occur unless the temp section is not created yet...
    ...
    ' Removes section by object, returns true on success
