...
Public Class Download
    ...
    Private Sub Download_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not My.Computer.Network.IsAvailable Then
            If MessageBox.Show(String.Format("No internet connection found {0} do you want to cancel the download ?", vbLf), "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then
                ok = False
