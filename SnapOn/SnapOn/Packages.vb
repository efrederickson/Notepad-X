...
Public NotInheritable Class Packages
    ...
    Public Shared Function Unpack(ByVal PackFilePath As [String], ByVal DestinationFolder As [String]) As Boolean
        ...
        For Each File As [String] In Files
            ...
            Dim FilePath As [String] = String.Format("{0}\{1}", DestinationFolder, FileName)
            If System.IO.File.Exists(FilePath) Then
                System.IO.File.Delete(FilePath)
            End If
            If FileName.Contains("\") Then
                If Not System.IO.Directory.Exists(String.Format("{0}\{1}", DestinationFolder, FileName.Split("\"c)(0))) Then
                    System.IO.Directory.CreateDirectory(String.Format("{0}\{1}", DestinationFolder, FileName.Split("\"c)(0)))
                End If
            End If
